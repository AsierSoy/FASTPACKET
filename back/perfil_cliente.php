...
if(isset($_GET['page']))
{
    ...
    $arrayObjEnvio= $cms->selectMisEnvios($orden,$_SESSION["id_usuario"]);
...
<?php include './col/nav.php'; ?>
    ...
    <br /><br /><br />
       <div class="row text-center">
            <div class="col-md-12">
                <h1><span class="glyphicon glyphicon-star"></span> <?php echo $lengua['ZONA_CLIENTE']; ?> <span class="glyphicon glyphicon-star"></span> </h1> 
            </div>
        </div>
    <hr />
<div class="container">
