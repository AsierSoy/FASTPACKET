...
if($sesion->tieneSesion("id_usuario")){
    ...
    {
        //No está activado aún, le llevamos a página reenviar mensaje activación
...
else
{
    if($_POST)
	{
        ...
        if($usuario=$login->comprobarUsuario($email, $password))
		{
			$sesion->estableceSesion("id_usuario",$usuario->getId());
			$Activado=$usuario->getActivado();
		...
		{
            $mng='<div class="alert alert-danger" role="alert"><span class="glyphicon glyphicon-warning-sign" aria-hidden="true"></span>   ' .  $lengua['ERROR_LOGIN']  . '</div>';
        }
   }	    
}
?>
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    ...
    <div class = "container ">   <div class="row text-center">
            <div class="col-md-12">
                <h1><span class="glyphicon glyphicon-star"></span> <?php echo $lengua['LOGIN_TITLE']; ?> <span class="glyphicon glyphicon-star"></span> </h1> 
            </div>
        </div>
    <hr />
                    	...
                    	<form action="<?=  htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post" >       
			              ...
			              <hr class="colorgraph"><br>
                            ...
                            <br />
                             ...
                             <div class="input-group">
                              <span class="input-group-addon" id="basic-addon2"><?php echo $lengua['LOGIN_CLAVE']; ?></span>
                              <input type="password" class="form-control"  name="password"  placeholder="Password" required ="" autofocus="" aria-describedby="basic-addon2">
                            </div>
			              ...
			              <hr />
                            ...
                            <div class="row text-center">
                                ...
                                <div class="col-md-12">
                                      ...
                                      <button class="btn btn-lg btn-primary btn-block"  name="Submit" value="Login" type="Submit"><?php echo $lengua['LOGIN_ENTRAR']; ?></button>  
                                </div>
                            </div>
