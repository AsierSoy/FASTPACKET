...
$page = 'http://' . $_SERVER['HTTP_REFERER'];
if (strpos($page, 'registro.php') === false ) 
{
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
     ...
     <div class = "container "> 
          <div class="row text-center">
            <div class="col-md-12">
                <h1><span class="glyphicon glyphicon-star"></span> <?php echo $lengua['REGISTRO_OK_TITLE']; ?> <span class="glyphicon glyphicon-star"></span> </h1> 
            </div>
        </div>
    <hr />
            <div class="row ">
            ...
            <div class="col-md-6">
                <div class="well text-center">
                     ...
                     <div class="alert alert-success" role="alert"><h3>   <?php echo $lengua['REGISTRO_OK_AVISO1'];?>  </h3>
                       <div class="alert alert-warning" role="alert"><h5><span class="glyphicon glyphicon-warning-sign"></span>   <?php echo $lengua['REGISTRO_OK_AVISO2'];?>  </h5></div>
